...
const sampleInstructions = [
    ...
    { name: "LDD", description: "Load from user memory at fixed address (optional sugar: Rn, [0xADDR]).", syntax: "LDD Rn, 0xADDR", example: "LDD R2, 0x0008", useLine: "LDD R3, 0x00FF" },
    { name: "LDR", description: "Load from user memory via pointer: Rn = Mem[Rptr]. Sugars as LDD Rn, [Rptr] when ptr is not R0/R1.", syntax: "LDR Rd, Rptr", example: "LDR R4, R2", useLine: "LDR R3, R7" },
