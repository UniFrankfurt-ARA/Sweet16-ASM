...
const sampleInstructions = [
    ...
    { name: "ROL", description: "Rotate left through carry: rd = (rs[14:0], CF); MSB of rs → CF.", syntax: "ROL Rd, Rs", example: "ROL R2, R3", useLine: "ROL R3, R3" },
    { name: "ROR", description: "Rotate right through carry: rd = (CF, rs[15:1]); LSB of rs → CF.", syntax: "ROR Rd, Rs", example: "ROR R2, R3", useLine: "ROR R3, R3" },
    ...
    { name: "STO", description: "Store to user memory: Mem[Rs] = Rt. Put the address in register Rs.", syntax: "STO [Rs], Rt", example: "STO [R2], R3", useLine: "STO [R3], R3" },
    { name: "LDD", description: "Load from user memory: Rd = Mem[Rs]. Address must be in register Rs.", syntax: "LDD Rd, [Rs]", example: "LDD R4, [R2]", useLine: "LDD R3, [R3]" },
