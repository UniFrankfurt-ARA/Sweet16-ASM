...
(function(global) {
  global.I18N_DE = {
    ...
    msg: {
      ...
      programFinished: "Programm beendet ({reason}). Speicher erhalten — erster „Nächster Schritt“ setzt nur PC auf Anfang.",
      programFinishedAfterRun: "Alles ausführen beendet. Speicher auslesen; erster „Nächster Schritt“ rewind ohne Befehl.",
      rewindPcNoExecute: "PC zurück auf Anfang — kein Befehl gelaufen (Speicher unverändert).",
